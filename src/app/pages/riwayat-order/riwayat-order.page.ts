...
@Component({
  selector: 'riwayat-order',
  templateUrl: './riwayat-order.page.html',
  styleUrls: ['./riwayat-order.page.scss'],
})
export class RiwayatOrderPage implements OnInit {
...
goto_detail(id){
  this.router.navigateByUrl('/riwayat-order-detail/' + id );
}
konfirmasi(id){
